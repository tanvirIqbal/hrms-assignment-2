...
class PerformanceReviewControlTest {
	private PerformanceReviewControl performanceReviewControl;
    ...
    void setUp() {
        ...
        performanceReviewControl = new PerformanceReviewControl(new ArrayList<>(), employeeList);
    }

	 @Test
	    void testGetEmployeeNameByID_ExistingEmployee() {
	        String name = performanceReviewControl.getEmployeeNameByID(1);
	        assertEquals("John Doe", name);
	    }

	    @Test
	    void testGetEmployeeNameByID_NonExistingEmployee() {
	        String name = performanceReviewControl.getEmployeeNameByID(99);
	        assertEquals("Employee is not found.", name);
	    }

	    @Test
	    void testGetEmployeeNameByID_EmptyEmployeeList() {
	        performanceReviewControl = new PerformanceReviewControl(new ArrayList<>(), new ArrayList<>());
	        String name = performanceReviewControl.getEmployeeNameByID(1);
	        assertEquals("Employee is not found.", name);
	    }
